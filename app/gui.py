...
class WeedDetectorGUI:
    ...
    def create_control_panel(self, parent):
        ...
        tk.Label(settings_frame, text="Confidence:", bg="#34495e",
                 fg="#bdc3c7").pack(anchor="w", padx=10)
    ...
    def create_display_panel(self, parent):
        ...
        canvas_frame = tk.Frame(display_frame, bg="#2c3e50",
    ...
    def create_robot_status_panel(self):
        ...
        robot_results_frame.pack(fill="both", expand=True, padx=10,
                                 pady=(0, 10))
        ...
        robot_status_scrollbar = ttk.Scrollbar(robot_results_frame,
                                               orient="vertical",
                                               command=self.results_text.yview)
        self.robot_actions_text.configure(
            yscrollcommand=robot_status_scrollbar.set)
    ...
    def start_robot(self):
        ...
        if hasattr(self, "on_start_robot") and callable(self.on_start_robot):
            self.on_start_robot()
            self.robot_btn.config(text="Stop Robot", bg="#e74c3c",
